...
ColdFusion (CFML) is an interpreted and dynamic language that compiles to Java Bytecode directly, thus running in the JVM.  Implementations of the language are mostly done by two parties: Adobe ColdFusion (Commercial) and Lucee Server (Open Source)
