...
In later chapters we will investigate the concept of [dependency injection](/dependency-injection.md). Please also note that the `createObject()` function is also used to create different types of objects like:
